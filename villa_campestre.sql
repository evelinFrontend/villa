...
--
-- Host: localhost
-- Generation Time: Sep 26, 2019 at 01:08 AM
...
INSERT INTO `detalle_movimiento` (`id_det_mov`, `id_movimiento`, `id_producto`, `det_mov_cantidad`, `fecha`) VALUES
(1, 5, 14, 10, '2019-09-24'),
(2, 13, 8, 1, '2019-09-24'),
(3, 13, 9, 5, '2019-09-24'),
(4, 14, 8, 1, '2019-09-24'),
(5, 14, 9, 5, '2019-09-24'),
...
(7, 15, 9, 5, '2019-09-24'),
(8, 16, 8, 1, '2019-09-24'),
(9, 16, 9, 55, '2019-09-24'),
(10, 19, 14, 10, '2019-09-24'),
(11, 19, 12, 19, '2019-09-24'),
(12, 20, 14, 1, '2019-09-24'),
(13, 21, 14, 1, '2019-09-24'),
(14, 22, 14, 1, '2019-09-24'),
(15, 23, 14, 987, '2019-09-24'),
(16, 25, 14, 1, '2019-09-24'),
(17, 26, 14, 1, '2019-09-24'),
(18, 27, 12, 2, '2019-09-24'),
(19, 28, 13, 789087, '2019-09-24'),
(20, 29, 14, 5, '2019-09-24'),
(21, 29, 12, 6, '2019-09-24'),
(22, 29, 13, 7, '2019-09-24'),
(23, 30, 14, 1, '2019-09-24'),
(24, 31, 14, 1, '2019-09-24'),
(25, 32, 14, 2, '2019-09-24'),
(26, 33, 14, 3, '2019-09-24');
...
(2, 1, 'sad', 2, '2019-09-08', 1),
(3, 2, '221', 6, '2019-09-08', 1),
(4, 3, '213', 2, '2019-09-08', 1),
(5, 2, '2121321321321', 2, '2019-09-08', 1),
...
(8, 'PNE-001', 'Prod 1', 19000, 20000, 4, 4, 'img_deafult_product.jpg', 132, '2019-09-12', '2019-09-12', 1),
(9, 'PNE-002', 'Prod 2', 19000, 20000, 4, 4, 'img_deafult_product.jpg', 18, '2019-09-13', '2019-09-13', 1),
(12, '78678', 'Prod 3', 78678, 10000, 4, 5, 'img_deafult_product.jpg', 3, '2019-09-14', '2019-09-14', 1),
(13, '89765', 'Prod 4', 98765, 15000, 4, 5, 'img_deafult_product.jpg', -6, '2019-09-14', '2019-09-14', 1),
(14, '567890', 'Prod 5', 9876544567890, 30000, 4, 5, 'img_deafult_product.jpg', 0, '2019-09-14', '2019-09-14', 1);
...
(114, 2, 6, NULL, '2019-09-25 11:47:41', NULL, NULL, 2, 0, 2, NULL),
(116, 1, 6, NULL, '2019-09-25 15:23:16', NULL, NULL, 0, 0, 2, NULL),
(117, 4, 6, NULL, '2019-09-25 15:25:04', '2019-09-25 16:28:43', '2019-09-25 16:29:44', 0, 0, 2, NULL),
(120, 5, 6, NULL, '2019-09-25 16:18:51', NULL, NULL, 0, 0, 2, NULL);
...
(267, 114, 8, 1, 19000, 20000, 20000),
(268, 114, 13, 1, 98765, 15000, 15000),
(292, 116, 8, 1, 19000, 20000, 20000);
...
--
ALTER TABLE `detalle_movimiento`
  MODIFY `id_det_mov` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
ALTER TABLE `reserva_activa`
  MODIFY `id_reserva` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=121;

--
-- AUTO_INCREMENT for table `reserva_activa_detalle`
--
ALTER TABLE `reserva_activa_detalle`
  MODIFY `id_detalle` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=295;
